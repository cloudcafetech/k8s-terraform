...
resource "null_resource" "k8s-haproxy-lb-setup" {
    ...
    provisioner "remote-exec" {
      inline = [
        ...
        "sed -i -e 's:VMDNS1:k8skube-master-1:g' -e 's:VMDNS2:k8skube-master-2:g' -e 's:VMIP1:${google_compute_instance.k8skube-master-1.network_interface[0].network_ip}:g' -e 's:VMIP2:${google_compute_instance.k8skube-master-2.network_interface[0].network_ip}:g' haproxy.cfg",
